...
export function PrivacyPolicy() {
  return (
    <div className="flex-1 min-h-0 bg-linear-to-br from-[#faf7f2] to-[#f5f0e6] overflow-y-auto flex justify-center items-start sm:items-center font-body px-3 py-6 sm:px-6 sm:py-10">
      <div className="w-full max-w-2xl bg-white border border-border-warm rounded-2xl shadow-[0_4px_20px_rgba(0,0,0,0.03)] p-5 sm:p-8 md:p-12 relative animate-fade-in">
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h2 className="font-display text-xl sm:text-2xl font-semibold text-foreground m-0">
              Privacy & Data Policy
            </h2>
