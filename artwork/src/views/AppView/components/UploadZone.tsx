...
export function UploadZone() {
  ...
  return (
    <div
      className={`w-full max-w-lg border-2 border-dashed border-border-warm rounded-xl py-8 sm:py-10 px-4 sm:px-5 text-center bg-linear-to-br from-background to-surface-card transition-all duration-300 cursor-pointer hover:border-sienna ${
        isDragging
